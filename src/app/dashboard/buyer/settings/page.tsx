        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6">
              ...
              <div className="flex-1 text-center sm:text-left">
                ...
                <div className="flex flex-wrap gap-2 mt-3 justify-center sm:justify-start">
                  ...
                  <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-blue-50 text-blue-600 rounded-full text-sm font-medium border border-blue-100">
                    <User size={14} />
                    Pembeli
                  </span>
                </div>
          ...
          <div className="p-6 lg:p-8">
            <h3 className="text-lg font-semibold text-gray-900 mb-6 flex items-center gap-2">
              <User className="text-[#39D177]" size={20} />
              Informasi Personal
            </h3>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Menghapus akun akan menghilangkan seluruh data secara permanen dan tidak dapat dibatalkan.
                </p>
                  ...
                  <AlertDialogContent className="rounded-2xl max-w-md">
                    <AlertDialogHeader className="text-center sm:text-left">
                      ...
                      <AlertDialogDescription className="text-gray-500">
                        Tindakan ini tidak dapat dibatalkan. Semua data, profil, dan riwayat Anda akan dihapus secara permanen.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
